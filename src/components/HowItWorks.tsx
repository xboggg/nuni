...
const steps = [
  {
    ...
    description:
      "Browse our collection of premium African skincare products. Each formulated with 100% natural ingredients.",
  },
  {
    ...
    description:
      "Simply send us a message on WhatsApp. We'll confirm your order and answer any questions you have.",
  },
  {
    ...
    description:
      "Fast delivery across Ghana and beyond. Your skincare journey begins at your doorstep.",
  },
];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Getting your favorite Nuni Global products is easy. Just three simple
            steps to radiant, healthy skin.
          </p>
        </motion.div>
