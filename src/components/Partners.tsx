...
import { getWhatsAppLink, PARTNER_INQUIRY_MESSAGE } from "@/data/products";
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-foreground mb-6">
              Become a Nuni Global{" "}
              <span className="text-gradient-gold">Partner</span>
            </h2>

            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Join our growing network of resellers across Ghana and beyond.
              Partner with us to bring premium African skincare to your
              community and build a profitable business.
            </p>
            ...
            {/* CTA */}
            <a
              href={getWhatsAppLink(PARTNER_INQUIRY_MESSAGE)}
              target="_blank"
